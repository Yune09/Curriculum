            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <form action="{{ route('curriculums.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        @csrf
                      <div class="mb-4">
                      <label for="id" class="block text-gray-700 text-sm font-bold mb-2">ID del Currículum (para editar o eliminar):</label>
                     <input type="text" name="id" placeholder="ID del Currículum" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                     </div>
                        ...
                        <div class="flex items-center justify-between mt-6">
                            ...
                            <a href="{{ route('curriculums') }}" class="inline-block align-baseline font-bold text-sm text-blue hover:text-green-darker">
                                CANCELAR
                            </a>
